								   ...
								   new Dictionary<int, string>
									   {
										   ...
										   {2, ScopeName.HeadingOneBody},
										   {3, ScopeName.HeadingOneEnd}
									   }),
							   new MacroRule(
								   @"^:*\s?(!!\s)([^\r\n]*)(\r?\n|$)",
								   new Dictionary<int, string>
									   {
										   ...
										   {2, ScopeName.HeadingTwoBody},
										   {3, ScopeName.HeadingTwoEnd}
									   }),
							   new MacroRule(
								   @"^:*\s?(!!!\s)([^\r\n]*)(\r?\n|$)",
								   new Dictionary<int, string>
									   {
										   ...
										   {2, ScopeName.HeadingThreeBody},
										   {3, ScopeName.HeadingThreeEnd}
									   }),
							   new MacroRule(
								   @"^:*\s?(!!!!\s)([^\r\n]*)(\r?\n|$)",
								   new Dictionary<int, string>
									   {
										   ...
										   {2, ScopeName.HeadingFourBody},
										   {3, ScopeName.HeadingFourEnd}
									   }),
							   new MacroRule(
								   @"^:*\s?(!!!!!\s)([^\r\n]*)(\r?\n|$)",
								   new Dictionary<int, string>
									   {
										   ...
										   {2, ScopeName.HeadingFiveBody},
										   {3, ScopeName.HeadingFiveEnd}
									   }),
								new MacroRule(
								   @"^:*\s?(!!!!!!\s)([^\r\n]*)(\r?\n|$)",
								   new Dictionary<int, string>
									   {
										   ...
										   {2, ScopeName.HeadingSixBody},
										   {3, ScopeName.HeadingSixEnd}
									   })
						   };
			}
		}
