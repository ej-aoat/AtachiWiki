		...
		protected override ICollection<string> ScopeNames
		{
			get
			{
				return new[] {
								...
								ScopeName.UnderlineBegin, ScopeName.UnderlineEnd, 
								/*
								ScopeName.HeadingOneBegin, ScopeName.HeadingOneEnd, 
								ScopeName.HeadingTwoBegin, ScopeName.HeadingTwoEnd,
								ScopeName.HeadingThreeBegin, ScopeName.HeadingThreeEnd, 
								ScopeName.HeadingFourBegin, ScopeName.HeadingFourEnd, 
								ScopeName.HeadingFiveBegin, ScopeName.HeadingFiveEnd,
								ScopeName.HeadingSixBegin, ScopeName.HeadingSixEnd, 
								*/
								ScopeName.StrikethroughBegin,
